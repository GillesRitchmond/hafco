            ...
            <table id="dataTable" class="display wrap" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="row">
                            <div class="col-md-4"><a href="edit/edit-user.php?edit_user_id='.$row['id'].'" class="nav-link"><span class="material-icons-outlined nav-item"> mode_edit </span></a></div>
                            <div class="col-md-4"><a href="userTable.php?delete_user_id='.$row['id'].'" class="nav-link text-danger"><span class="material-icons-outlined"> delete </span></a></div>
                        </div>
