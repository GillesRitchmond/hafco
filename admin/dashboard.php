...
<html>
    ...
    <body>
        ...
        <div class="row mt-5 mx-4 g-2 ">
                <div class="col-sm-2" data-bs-spy="scroll">
                ...
                <div class="col-sm-9 bg-light p-2" id="table-container">
                    <?php
    ...
    function home(){
        include('../Model/Connection.php');
            ...
            echo '
                <div class="container">
                    <div class="row mt-4">
                        <div class="col-md-8"> <h3>Tableau de bord de la HAFCO</h3> </div>
                </div>
            <hr>';
            ...
            if (mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3 p-3 bordered">
            ...
            echo '
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 p-3 bordered"  id="newProduct">
                            <div class="row bg-white p-2 rounded">
                                <div class="mt-3">
                        ...
                        echo '
                            ...
                            echo'
                                            ...
                                            <button class="btn btn-primary col-12 form_btn mt-4" name="upload">Ajouter</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    echo'
                                    <form method="POST">
                                            ...
                                            <button class="btn btn-primary col-12 form_btn mt-4">Ajouter</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 p-3 bordered" id="newCategory">
                            <div class="row bg-white p-2 rounded">';
                    ...
                    echo'
                        ...
                        <div class="col-md-6 p-3 bordered" id="newSubCategory">
                            <div class="row bg-white p-2 rounded">
                                <div class="mt-3">
