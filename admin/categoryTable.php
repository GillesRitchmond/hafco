                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="modal-footer">
                                                            <a href="categoryTable.php?delete_category_id='.$row['id'].'" class="btn btn-warning">Valider</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        echo '
                                            <tr>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4"><a href="edit/edit-category.php?edit_category_id=' . $row['id'] . '" class="nav-link"><span class="material-icons-outlined"> mode_edit </span></a></div>
